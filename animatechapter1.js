    ...
    const satellitePopupConfig = {
      ...
      popupHtml: `
        <div class="enhanced-popup">
          <img src="gulfstream-9thfeb2024.png" class="annotation-img" alt="Gulfstream crash satellite imagery">
        </div>
      `,
    ...
    if (!document.getElementById('chapter1-styles')) {
      ...
      style.textContent = `
        ...
        .chapter1-popup .enhanced-popup .annotation-img {
          width: 170px !important;    /* <-- CHANGE THIS to increase/decrease image width */
